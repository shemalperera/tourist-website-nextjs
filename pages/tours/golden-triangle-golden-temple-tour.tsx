        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:mt-24 lg:px-11 lg:py-4 max-lg:hidden">
                <div className="flex items-center lg:text-lg gap-4 font-Roboto">
                    ...
                    <MdOutlineKeyboardArrowRight />
                    <div><Link href={'/golden-triangle-golden-temple-tour'} className="hover:text-blue-800 text-orangemix">The Golden Triangle with Golden Temple Tour</Link></div>
                </div>
            </div>
                    ...
                    <div className='grid grid-cols-1'>
                        <div>
                            <Image className="object-cover w-max  rounded-l-2xl"
                                src={'/asset/tours/golden-temple.jpg'}
                                alt="taj-mahal"
                                width={400}
                                height={400}
                            />
            ...
            <div className=" grid lg:grid-cols-6  max-lg:grid-rows-4 lg:p-4">
                <div className=" lg:col-span-4 max-lg:row-span-3 lg:p-4">
                    ...
                    <div className="grid grid-cols-1 gap-2 max-lg:p-2">
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 07</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">NEW DELHI- AMRITSAR</div></div>
                            ...
                            <div>
                                {(showDay7) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning departure for the flight to Amritsar. The city is famous for the golden temple. Golden Temple -is the holiest temple for Sikhs. Arrival in Amritsar and check-in at the hotel. In the afternoon we will visit wagah border to see the flag ceremony between India and Pakistan. Wagah is the only open land border between Pakistan and India. The ceremony begins with a parade by soldiers from both sides and ends with the perfectly coordinated lowering of the flags of the two nations. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 08</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">AMRITSAR - NEW DELHI</div></div>
                            ...
                            <div>
                                {(showDay8) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning, we will visit the golden temple. The temple located in the heart of the city. The Golden Temple also known Sri Harmandir Sahib. It represents the distinct identity, glory and heritage of the Sikhs. The Golden Temple has unique Sikh architecture. It is an impressive complex, and always packed with thousands of pilgrims from all over India. visit Jalliawala bagh, It bears witness to one of the cruelest massacres of the pre-independence era, and thus has become the symbol of national importance and remembrance. In the afternoon, transfer to the airport to take the flight to New Delhi. Arrive in Delhi and check-in hotel. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 09</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">NEW DELHI - RETURN TO YOUR COUNTRY</div></div>
                            ...
                            <div>
                                {(showDay9) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After breakfast. According to your flight schedule transfer to Delhi airport to take the flight.</div> : <></>}
                            </div>
                        </div>
...
export default GoldenTraingleTemple
