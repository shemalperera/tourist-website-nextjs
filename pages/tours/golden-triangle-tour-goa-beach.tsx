        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:mt-24 lg:px-11 lg:py-4 max-lg:hidden">
                <div className="flex items-center lg:text-lg gap-4 font-Roboto">
                    ...
                    <MdOutlineKeyboardArrowRight />
                    <div><Link href={'/tours/golden-triangle-tour-goa-beach'} className="hover:text-blue-800 text-orangemix">The golden triangle with beaches of Goa Tour</Link></div>
                </div>
            </div>
            <div className="grid grid-cols-1  font-Nunito font-medium  lg:px-11 max-lg:p-4">
                ...
                <div className="lg:text-4xl  max-lg:text-2xl max-lg:font-bold">
                    The golden triangle with beaches of Goa Tour
                </div>
                    ...
                    <div className="grid grid-rows-2">
                        ...
                        <div className="grid grid-cols-2">
                            <div className="px-1 pt-1">
                                <Image className="w-80 h-52 "
                                    src={'/asset/tours/golden-traingle/amber-fort.jpg'}
                                    alt="taj-mahal"
                                    width={400}
                                    height={400}
                                />
            ...
            <div className=" grid lg:grid-cols-6  max-lg:grid-rows-4 lg:p-4">
                <div className=" lg:col-span-4 max-lg:row-span-3 lg:p-4">
                    <div className="max-lg:hidden gap-3 flex flex-row px-5 justify-between ">
                        ...
                        <div className="flex gap-3 font-Roboto items-center max-lg:w-44">
                            ...
                            <div className="">
                                ...
                                <div className="text-sm text-gray-600 font-semibold">04 to 07 Days</div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 gap-2 max-lg:p-2">
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 07</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">NEW DELHI - GOA</div></div>
                            ...
                            <div>
                                {(showDay7) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning, departure for the flight to Goa. Goa, though, is the smallest state in India, but it is one of the best-known tourist destinations in the country. Goa is famous for its beaches. Chilling on its beaches is a favourite recreational activity of people in Goa. Goa beaches are ranked among the best beach destinations in the world. The Goa area is covered with groves of cashews, mangoes and coconuts. Arrive in Goa and check-in at the hotel. Today you have a free afternoon to walk along the wonderful beaches. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 08</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">Visit the City GOA</div></div>
                            ...
                            <div>
                                {(showDay8) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast at the hotel, In the morning visit the old city of Goa. The old city famous for beautiful Churches, Cathedrals, Temples, the Portuguese quarter and the old Portuguese markets which are excellent works of architecture. The Bom Jesus Cathedral is the best-known church in Goa. This church is 16th century architecture and is the first Minor Basilica in India. Also, you can visit a wax world museum about Indian history, culture and heritage in the old city of Goa. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 09</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">The wonderful beaches in GOA</div></div>
                            ...
                            <div>
                                {(showDay9) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>Today relax and enjoy the wonderful beaches. Also, you can do water sports. Apart from water sports activities it is a popular shopping destination. The best-selling items here are dresses and crafts. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 10</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">GOA - Return to Your Country</div></div>
                            ...
                            <div>
                                {(showDay10) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast at the hotel, Transfer to the airport, Flight to your country. We are sure that you will have these unforgettable memories forever. Namaste & Greetings!!!!!</div> : <></>}
                            </div>
                        </div>
