        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:mt-24 lg:px-11 lg:py-4 max-lg:hidden">
                <div className="flex items-center lg:text-lg gap-4 font-Roboto">
                    ...
                    <MdOutlineKeyboardArrowRight />
                    <div><Link href={'/golden-triangle-yoga-tour'} className="hover:text-blue-800 text-orangemix">The golden triangle tour with Yoga</Link></div>
                </div>
            </div>
            <div className="grid grid-cols-1  font-Nunito font-medium  lg:px-11 max-lg:p-4">
                ...
                <div className="lg:text-4xl  max-lg:text-2xl max-lg:font-bold">
                    The Golden Triangle Tour with Yoga
                </div>
                ...
                <div className=" lg:col-span-4 max-lg:row-span-3 lg:p-4">
                    <div className="max-lg:hidden gap-3 flex flex-row px-5 justify-between ">
                        ...
                        <div className="flex gap-3 font-Roboto items-center max-lg:w-44">
                            ...
                            <div className="">
                                ...
                                <div className="text-sm text-gray-600 font-semibold">10 to 11 Days</div>
                            </div>
                        </div>
                    ...
                    <div className="lg:p-4 max-lg:p-2">
                        ...
                        <div className=" font-Poppins lg:pl-4 max-lg:text-sm lg:text-base lg:text-gray-600">
                            The detailed and suggested golden triangle trip itinerary for India. One of the most visited regions of India and explore the rich past from Delhi to the dazzling Taj Mahal in Agra with Rajputana architecture and value of Jaipur, the city of victory.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-2 max-lg:p-2">
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 06</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">AGRA - NEW DELHI </div></div>
                            ...
                            <div>
                                {(showDay6) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After breakfast. Visit the famous Taj Mahal, the legendary monument of love. The Taj Mahal is widely recognized as the jewel of Muslim art in India, and remains one of the most famous structures in the world and a symbol of India rich history. It was built by Emperor Shah Jehan in 1630 with marble, to remember his beloved Mumtaz Mahal (closed on every Friday). Visit the Red Fort a UNESCO site and it is a historical fort which remained the main residence of the Mughal emperors until 1638. You can also visit the Agra souvenir market. In the afternoon departure to New Delhi. Arrival in Delhi and check-in in hotel.  Over Night stay at the Hotel.</div> : <></>}
                            </div>
                        </div>

                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 07</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">NEW DELHI - HARIDWAR</div></div>
                            ...
                            <div>
                                {(showDay7) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning departure by train to Haridwar. The city of Haridwar is also known as The gateway to the god. It is one of the Hindu holy places in India and a center of the Hindu religion. Haridwar is blessed with a rich ancient Hindu religious and cultural heritage. Arrival at Haridwar and drive for Rishikeh. Rishikesh known as The Yoga Capital of the World. Rishikesh is a very religious city that is placed in the Indian state of Uttarakhand. It is also known as the gateway to the Himalayas. Rishikesh is a holy city with so many Ashrams (Hermitages) and is famous for yoga in the world. Check-in Ashram. Accommodation at the Ashram.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 08</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">HARIDWAR - RISHIKESH</div></div>
                            ...
                            <div>
                                {(showDay8) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>Early morning do yoga and meditation in Ashram with Yoga master. Breakfast in Ashram. You can visit by Lakshman Jhula, Ram jhula and spend time at River Ganges. Accommodation at the Ashram.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 09</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">DO YOGA IN RISHIKESH</div></div>
                            ...
                            <div>
                                {(showDay9) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>Rishikesh has very beautiful atmosphere which has attracted so many spiritual people as well as peace seekers since ancient times. In the early morning you can do Yoga and Meditation in the Ashram (The hermitage). You have an excellent opportunity to receive an unforgettable experience from the hermitage. Also, you can do Ayurveda in the hermitage. Ayurveda is a traditional form or system of medicines of Indian origin. Accommodation at the Ashram.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 10</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">RISHIKESH - HARIDWAR - NEW DELHI</div></div>
                            ...
                            <div>
                                {(showDay10) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning departure to New Delhi by train. Arrival in New Delhi and check-in at the hotel. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            ...
                            <div>
                                {(showDay11) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After breakfast. According to your flight schedule transfer to Delhi airport to take the flight.
                                    </div> : <></>}
                            </div>
                        </div>
...
export default GoldenTraingleYoga
