...
const Destination = ({ destinations }: { destinations: DestinationCard[] }) => {
  return (
    <div>
      ...
      <div className='grid grid-cols-4 p-4'>
        {destinations.map((destination) => (
          <div
            ...
            className='flex flex-col gap-2 bg-white shadow-slate-200 p-1 h-84 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl'
          >
            <div>
              <Image
