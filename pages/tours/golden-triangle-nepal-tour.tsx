        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:mt-24 lg:px-11 lg:py-4 max-lg:hidden">
                <div className="flex items-center lg:text-lg gap-4 font-Roboto">
                    ...
                    <MdOutlineKeyboardArrowRight />
                    <div><Link href={'/golden-triangle-nepal-tour'} className="hover:text-blue-800 text-orangemix">The golden triangle India with Nepal Tour</Link></div>
                </div>
            </div>
            <div className="grid grid-cols-1  font-Nunito font-medium  lg:px-11 max-lg:p-4">
                ...
                <div className="lg:text-4xl  max-lg:text-2xl max-lg:font-bold">
                    The golden triangle India with Nepal Tour
                </div>
                    ...
                    <div className='grid grid-cols-1'>
                        <div>
                            <Image className="object-cover w-max  rounded-l-2xl"
                                src={'/asset/tours/golden-triangle-nepal/kathmandu1-small.jpg'}
                                alt="taj-mahal"
                                width={400}
                                height={400}
                            />
                        ...
                        <div className="grid grid-cols-2">
                            <div className="px-1 pb-1">
                                <Image className="w-80 h-52 "
                                    src={'/asset/tours/golden-triangle-nepal/nagarkot.jpg'}
                                    alt="taj-mahal"
                                    width={400}
                                    height={400}
                                />
            ...
            <div className=" grid lg:grid-cols-6  max-lg:grid-rows-4 lg:p-4">
                <div className=" lg:col-span-4 max-lg:row-span-3 lg:p-4">
                    ...
                    <div className="grid grid-cols-1 gap-2 max-lg:p-2">
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 07</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">NEW DELHI - KATHMANDU, NEPAL</div></div>
                            ...
                            <div>
                                {(showDay7) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, in the morning Departure for the flight to Kathmandu. Arrival in Kathmandu. Our representative will receive you and check-in at the hotel. Kathmandu is the capital of Nepal. In the afternoon we will visit the city of Patan, it is best known for its rich cultural heritage, particularly its tradition of arts and crafts. The city Patan is taken as a Buddhist city, you can see many Buddhist sanctuaries, stupas, monasteries, etc. Over Night stay at the Hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 08</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">Visit the City KATHMANDU</div></div>
                            ...
                            <div>
                                {(showDay8) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning we will visit the places of Kathmandu. Monuments such as Kathmandu Durbar Square, is one of the three royal palaces in the Kathmandu Valley. Pashupatinath Temple, Pashupatinath is one of the top four religious’ sites in Asia for Shiva devotees. Boudhanath Stupa, the ancient stupa is one of the largest in the world. The Boudha Stupa built during the 5th century. Swayambhunath, it is an ancient religious complex on top of a hill in the Kathmandu Valley. Over Night stay at the Hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 09</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">Visit the City KATHMANDU and NAGARKOT </div></div>
                            ...
                            <div>
                                {(showDay9) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning we will visit Nagarkot. Nagarkot is a famous hill station with stunning views of the majestic Himalayas, rolling hills, deep valleys, lush pine forests in a rural and picturesque setting. Other famous mountains that can be seen from nagarkot like Ganesh, Lantang, Dorje Lakpa and Gauri Shanker etc. You can also visit the village markets and get to know the rural life of Nepal. Over Night stay at the Hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 10</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">KATHMANDU - NEW DELHI</div></div>
...
export default GoldenTraingleNepal
