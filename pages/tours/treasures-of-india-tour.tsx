...
const TreasureIndia = () => {
    ...
    const [showDay12, setshowDay12] = useState(false);
    const [showDay13, setshowDay13] = useState(false);
        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:mt-24 lg:px-11 lg:py-4 max-lg:hidden">
                <div className="flex items-center lg:text-lg gap-4 font-Roboto">
                    ...
                    <MdOutlineKeyboardArrowRight />
                    <div><Link href={'/treasures-of-india-tour'} className="hover:text-blue-800 text-orangemix">Treasures of India Tour</Link></div>
                </div>
            </div>
                ...
                <div className=" lg:col-span-4 max-lg:row-span-3 lg:p-4">
                    ...
                    <div className="grid grid-cols-1 gap-2 max-lg:p-2">
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            ...
                            <div>
                                {(showDay2) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning explore Old Delhi narrow streets and colourful Market during a rickshaw ride. Then we will visit Jama Masjid, the largest mosque in India in Old Delhi. Visit Raj Ghat, the cremation site of Mahatma Gandhi. Go through Rajpath, it is the ceremonial boulevard in front of the Presidents House. Qutub Minar, The Qutb Minar is made of red sandstone and marble a UNESCO site in Delhi. Visit the Gurudwara Bangla Sahiba a religious of the religion Sikh. Over Night stay at the Hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 06</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">AGRA- NEW DELHI (By Car) - VARANASI</div></div>
                            ...
                            <div>
                                {(showDay6) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>Early morning Sunrise Visit the famous Taj Mahal, the legendary monument of love. The Taj Mahal is widely recognized as the jewel of Muslim art in India, and remains one of the most famous structures in the world and a symbol of India rich history. It was built by Emperor Shah Jehan in 1630 with marble, to remember his beloved Mumtaz Mahal (closed on every Friday). Return to hotel and Breakfast. Then drive to Delhi to take the flight to Varanasi. It is an oldest city in the world. Varanasi or Benares and also known as Kashi (City of Life). Arrive in Varanasi and check-in at the hotel. Over Night stay at the Hotel.</div> : <></>}
                            </div>
                        </div>

                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 07</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">Visit the City VARANASI</div></div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 08</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">VARANASI - MUMBAI</div></div>
                            ...
                            <div>
                                {(showDay8) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>In the early morning, sunrise boat ride on the holy river Ganges in Varanasi. The ancient city of Varanasi, is located on the banks of the Ganges River and the Ghats of the holy Ganges River. The ghats are centres of a large number of religious activities.  This experience is very mystical and peaceful, it is exciting to see people offering their prayers and taking a bath in the river. Return to the hotel for breakfast. In the afternoon, departure for the flight to Mumbai. Mumbai is the financial, commercial and entertainment capital of India. Mumbai is a unique city in India, which is always on the go and never sleeps. One of the busiest metropolitan areas in the country, Mumbai society is multilingual and multicultural. Arrive in Mumbai and check-in at the hotel. Over Night stay at the Hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 09</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">Visit the City MUMBAI</div></div>
                            ...
                            <div>
                                {(showDay9) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast. In the morning we will visit the places of the city. Visit the Gateway of India, it was built in the Indo-Saracenic style and also known as the Taj Mahal of Mumbai. The Elephanta Caves (The Elephanta Caves), are located 9 km ferry from the gate of India, on an island in Gharapuri. These caves are part of the rock-hewn temples dating back to the 7th century. The main attraction is the three-headed bust of Lord Shiva, famously known as Trimurti. This place is also adorned with beautiful stone sculpture of Hindu Gods and Goddesses. We will also visit places like the Prince of Wales Museum, Marine drive beach, Mahatma Gandhi memorial, Girgaum Chowpatty. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 10</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">MUMBAI - AURANGABAD</div></div>
                            ...
                            <div>
                                {(showDay10) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning departure for the flight to Aurangabad. Aurangabad is one of the well-known tourist destinations in India. The city is known for its rich culture and heritage and its history dates back centuries. Ajanta and Ellora are popular tourist attractions of Aurangabad, which is considered as a UNESCO World Heritage Site. Arrive Aurangabad and check-in at the hotel. In the afternoon we will visit Bibi ka Maqbara, the white marble monument stands majestically in a deliberate attempt to copy and compete with Agra famous Taj Mahal. Accommodation at the hotel.
                                    </div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 11</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">Visit the Ajanta Caves in AURANGABAD</div></div>
                            ...
                            <div>
                                {(showDay11) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning we will visit the Ajanta caves. The Ajanta caves date back to the 2nd century. These are 30 rock-cut Buddhist caves with Buddha figures, representation of Jataka stories, paintings and sculptures. They are the best examples of Indian art, especially painting. All the paintings explore strong religious influence explaining the life of Buddha, Bodhisattvas, incidents of Buddhas life and the Jatakas. Accommodation at the hotel.
                                    </div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 12</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">Visit the Ellora Caves in AURANGABAD</div></div>
                                <div className='flex items-center'>{(!showDay12) ? <button onClick={() => setshowDay12(!showDay12)}><AiOutlinePlusCircle className='max-lg:text-2xl lg:text-3xl text-gray-700' /></button> : <></>}
                                    {(showDay12) ? <button onClick={() => setshowDay12(!showDay12)}><AiFillMinusCircle className=' max-lg:text-2xl lg:text-3xl text-redmix' /></button> : <></>}
                                </div>
                            </div>
                            <div>
                                {(showDay12) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast. In the morning we will visit the Ellora caves. The 34 ancient caves were built by the Rashtrakuta rulers around the 5th and 10th centuries. There are 12 Buddhist caves, 5 Jain caves and 17 Hindu caves. Ellora, also called Verula or Elura, is the cave form of the ancient name Elapura. Ellora known for its Buddhist, Jain and Hindu cultural influences. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>

                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 13</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">AURANGABAD - MUMBAI/NUEVA DELHI - Return to Your Country</div></div>
                                <div className='flex items-center'>{(!showDay13) ? <button onClick={() => setshowDay13(!showDay13)}><AiOutlinePlusCircle className='max-lg:text-2xl lg:text-3xl text-gray-700' /></button> : <></>}
                                    {(showDay13) ? <button onClick={() => setshowDay13(!showDay13)}><AiFillMinusCircle className=' max-lg:text-2xl lg:text-3xl text-redmix' /></button> : <></>}
                                </div>
                            </div>
                            <div>
                                {(showDay13) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning departure for the flight to New Delhi/Mumbai. Flight from New Delhi/Mumbai to your country. We are sure that you will have these unforgettable memories forever. Namaste & Greetings!!!!
                                    </div> : <></>}
                            </div>
                        </div>
