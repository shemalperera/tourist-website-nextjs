        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:mt-24 lg:px-11 lg:py-4 max-lg:hidden">
                <div className="flex items-center lg:text-lg gap-4 font-Roboto">
                    ...
                    <MdOutlineKeyboardArrowRight />
                    <div><Link href={'/royal-rajasthan-taj-mahal'} className="hover:text-blue-800 text-orangemix">Royal Rajasthan with Taj Mahal Tour</Link></div>
                </div>
            </div>
            ...
            <div className=" grid lg:grid-cols-6  max-lg:grid-rows-4 lg:p-4">
                <div className=" lg:col-span-4 max-lg:row-span-3 lg:p-4">
                    ...
                    <div className="grid grid-cols-1 gap-2 max-lg:p-2">
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 02</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">NEW DELHI - UDAIPUR</div></div>
                            ...
                            <div>
                                {(showDay2) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning transfer to airport to take the flight to Udaipur. it is known as Venice of the East and the City of Lakes. Arrive in Udaipur and check-in hotel. Then we will visit the city Udaipur. City Palace, is a beautiful, ancient and largest palace in India. Located on the shores of Lake Pichola. From the balcony of the City Palace, you can see a panoramic view of Pichola Lake. This lake Located in the heart of the city. You will enjoy a boat ride on this beautiful lake. Jagdish Temple, it is a great example of Indo-Aryan architecture temple. Saheliyon Ki Bari, is one of the most beautiful gardens. The beautiful garden has an excellent design that offers an impressive view. In the evening enjoy the folk dance and puppet show in Udaipur. Over Night stay at the Hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 03</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">UDAIPUR – KUMBHALGARH - RANAKPUR</div></div>
                            ...
                            <div>
                                {(showDay3) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning departure by road to Ranakpur. On the way we will visit the Kumbhalgarh Fort also known as the Great Wall of India is a Mewar fortress on the westerly range of Aravalli Hills. Then drive to Ranakpur and visit Ranakpur. Ranakpur is widely known for its marble Jain temples, they are famous for their great architecture and sculptures. The Jain temple built in the 15th century is located in the beautiful Aravali valley. You have an excellent opportunity to see the oldest mountains in India. Transfer to hotel and check-in at the hotel. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 04</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">RANAKPUR - JODHPUR</div></div>
                            ...
                            <div>
                                {(showDay4) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning departure by road to Jodhpur. Arrival in Jodhpur and check-in at the hotel. The Blue City of Rajasthan, Jodhpur has a bluish landscape and is characterized by herculean Mehrangarh Fort. In the afternoon we will visit Mehrangarh Fort, this is a major tourist attraction of the city, which stands on a perpendicular cliff, above the Jodhpur skyline. Jaswant Thada is another delight in Jodhpur. This white marble marvel is a monument dedicated to Maharaja Jaswant Singh. In evening visit the clock tower and Sardar market, an old-city style market in Rajasthan, the entire market is especially famous for Rajasthani handcrafted cloths, Hand-dyed textiles, embroidered leather items like shoes and purses, small toys of camels and elephants and traditional Rajasthani silver and gold jewellery are some of the most common items that you shall find easily in the Sardar Market. Over Night stay at the Hotel.
                                    </div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 05</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">JODHPUR - JAIPUR</div></div>
                            ...
                            <div>
                                {(showDay5) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast. In the morning departure to Jaipur. Jaipur is known as the Pink City of India, the traditional color of Welcome. Jaipur is one of the cities in India with the most history and one of the most visited. Arrive Jaipur and check-in at the hotel. Later we will visit the Birla temple and the Albert Hall Museum. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>

                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 06</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">Visit The City JAIPUR and AMBER</div></div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 08</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">AGRA – NEW DELHI </div></div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 09</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">Visit the City New and Old DELHI</div></div>
                            ...
                            <div>
                                {(showDay9) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>After Breakfast, In the morning explore Old Delhi narrow streets and colourful Market during a rickshaw ride. Then we will visit the places of the city.Jama Masjid, the largest mosque in India in Old Delhi. Raj Ghat, the cremation site of Mahatma Gandhi. Go through Rajpath, it is the ceremonial boulevard in front of the President House. Qutub Minar, The Qutb Minar is made of red sandstone and marble. Lotus Temple, Shaped like a lotus bud with 27 petals. You can also visit India Gate, Bangla Sahib Temple, and Askhardham Temple. Accommodation at the hotel.</div> : <></>}
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col  border border-gray-400 rounded-xl font-Roboto'>
                            <div className='flex justify-between items-center p-4'>
                                <div className='flex items-center gap-4'><div className="text-white max-lg:text-sm rounded-md p-2 bg-purple-700 ">Day - 10</div><div className="max-lg:text-sm max-lg:text-left max-lg:overflow-hidden max-lg:w-52">NEW DELHI – RETURN TO YOUR COUNTRY</div></div>
                            ...
                            <div>
                                {(showDay10) ?
                                    <div className='text-justify font-Poppins p-4 transition duration-150 ease-in-out leading-8'>In the morning Transfer to the airport, Flight from New Delhi to your country. We are sure that you will have these unforgettable memories forever. Namaste & Greetings!!!!!</div> : <></>}
                            </div>
                        </div>
